    ...
    <>
      {
        ...
        <p>Você morreu.</p>
        <Link to='/troll'><button class="button is-danger is-light is-outlined">Tentar novamente</button></Link>
        </>
        :
        <>
        <p>Seu ataque fez efeito, mas o troll ainda não foi derrotado.</p>
        <Link to='/trollataque2'><button class="button is-danger is-light is-outlined">Continuar</button></Link>
        </>
      }
    </>
   }
