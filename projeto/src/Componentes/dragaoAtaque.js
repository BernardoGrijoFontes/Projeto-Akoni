      ...
      <>
        {
          ...
          <p>Você morreu.</p>
          <Link to='/dragao'><button class="button is-danger is-light is-outlined">Tente novamente</button></Link>
          </>
          :
          <>
          <p>O dragão é muito mais forte que os outros inimigos.</p>
          <p>Seu ataque fez efeito, mas o dragão ainda não foi derrotado.</p>
          <Link to='/dragaoataque2'><button class="button is-danger is-light is-outlined">Continuar</button></Link>
          </>
        }
      </>
     }
