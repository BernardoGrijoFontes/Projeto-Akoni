      ...
      <>
        {
          ...
          <p>Você morreu.</p>
          <Link to='/magoataque'><button class="button is-danger is-light is-outlined">Tentar novamente</button></Link>
          </>
          :
          <>
          <p>Seu ataque fez efeito, mas o mago ainda não foi derrotado.</p>
          <Link to='/magoataque3'><button class="button is-danger is-light is-outlined">Continuar</button></Link>
          </>
        }
      </>
     }
