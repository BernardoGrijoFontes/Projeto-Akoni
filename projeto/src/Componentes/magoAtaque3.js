      ...
      <>
        {
          ...
          <p>Você morreu.</p>
          <Link to='/magoataque2'><button class="button is-danger is-light is-outlined">Tentar novamente</button></Link>
          </>
          :
          <>
          <p>Você derrotou o mago!</p>
          <Link to='/troll'><button class="button is-danger is-light is-outlined">Continuar</button></Link>
          </>
        }
      </>
