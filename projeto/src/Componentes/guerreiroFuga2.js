      ...
      <>
        {
          ...
          <p>Você morreu.</p>
          <Link to='/guerreirofuga'><button class="button is-danger is-light is-outlined">Tentar novamente</button></Link>
          </>
          :
          <>
          <p>Você consegue correr, mas o guerreiro ainda está atrás de você.</p>
          <Link to='/guerreirofuga3'><button class="button is-danger is-light is-outlined">Continuar</button></Link>
          </>
        }
      </>
     }
