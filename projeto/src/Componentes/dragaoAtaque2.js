      ...
      <>
        {
          ...
          <p>Você morreu.</p>
          <Link to='/dragaoataque'><button class="button is-danger is-light is-outlined">Tente novamente</button></Link>
          </>
          :
          <>
          <p>Seu ataque fez efeito, mas o dragão ainda não foi derrotado.</p>
          <Link to='/dragaoataque3'><button class="button is-danger is-light is-outlined">Continuar</button></Link>
          </>
        }
      </>
     }
