      ...
      <>
        {
          ...
          <p>Você morreu.</p>
          <Link to='/dragaoataque6'><button class="button is-danger is-light is-outlined">Tente novamente</button></Link>
          </>
          :
          <>
          <p>Você derrotou o dragão!</p>
          <Link to='/final'><button class="button is-danger is-light is-outlined">Continuar</button></Link>
          </>
        }
      </>
