      ...
      <>
        {
          ...
          <p>Você morreu.</p>
          <Link to='/guerreiroataque'><button class="button is-danger is-light is-outlined">Tentar novamente</button></Link>
          </>
          :
          <>
          <p>Seu ataque fez efeito, mas o guerreiro ainda não foi derrotado.</p>
          <Link to='/guerreiroataque3'><button class="button is-danger is-light is-outlined">Continuar</button></Link>
          </>
        }
      </>
     }
...
export default Guerreiroataque2